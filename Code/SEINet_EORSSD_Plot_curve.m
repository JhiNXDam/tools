...
%Models = {'SSAV'};
Models = {'SEINet', 'SEINet-R2',  'SEINet-R', 'SEINet-V',  'SARNet',  'RRNet', 'ACCoNet', 'ERPNet', 'EMFINet', 'DAFNet', 'MJRBM', 'AGNet',  'MCCNet'}; % 'AEINet', 'LVNet', 'SARNet', 'DAFNet', 'AGNet', 'RRNet', 'ACCoNet', 'MCCNet', 'MJRBM', 'ERPNet', 'EMFINet'
%Deep Model
...
%Results
ResDir = 'E:/matlab-code/MatlabEvaluationTools-main/Result_overall/';
...
for d = 1:datasetNum
    ...
    for i = 1 : length(plotMetrics.Alg_names)
        if i==1
            plot(plotMetrics.Recall(:,i), plotMetrics.Pre(:,i), 'Color', 'r', 'LineWidth', 2);   
        elseif i==2
        ...
        elseif i==11
            plot(plotMetrics.Recall(:,i), plotMetrics.Pre(:,i), '-.', 'Color', [0.4940 0.1840 0.5560], 'LineWidth', 2);
        elseif i==12
            plot(plotMetrics.Recall(:,i), plotMetrics.Pre(:,i), '-.', 'Color', [0.4660 0.6740 0.1880], 'LineWidth', 2);
        elseif i==13
            plot(plotMetrics.Recall(:,i), plotMetrics.Pre(:,i), '-.', 'Color', [0.3010 0.7450 0.9330], 'LineWidth', 2);
        end
...
%     end
    ...
    for i = 1 : length(plotMetrics.Alg_names)
        if i==1
            plot(x, plotMetrics.Fmeasure_Curve(:,i), 'Color', 'r', 'LineWidth', 2);
        elseif i==2
        ...
        elseif i==11
            plot(x, plotMetrics.Fmeasure_Curve(:,i), '-.', 'Color', [0.4940 0.1840 0.5560], 'LineWidth', 2);
        elseif i==12
            plot(x, plotMetrics.Fmeasure_Curve(:,i), '-.', 'Color', [0.4660 0.6740 0.1880], 'LineWidth', 2);
        elseif i==13
            plot(x, plotMetrics.Fmeasure_Curve(:,i), '-.', 'Color', [0.3010 0.7450 0.9330], 'LineWidth', 2);
        end
