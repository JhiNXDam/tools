...
%Models = {'SSAV'};
Models = {'MSAAFNet', 'SARNet', 'DAFNet', 'MJRBM', 'ERPNet', 'RRNet', 'EMFINet', 'MSCNet', 'SeaNet', 'MEANet'}; % 'AEINet', 'LVNet', 'SARNet', 'DAFNet', 'AGNet', 'RRNet', 'ACCoNet', 'MCCNet', 'MJRBM', 'ERPNet', 'EMFINet'
%Deep Model
