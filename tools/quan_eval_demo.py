...
# valset = ['HKU-IS', 'PASCALS', 'DUTOMRON', 'SOD', 'DUTS-TE','ECSSD']#
data_name = '' # this will be drawn on the bottom center of the figuresKDF 6TD
data_dir = r'E:/my_model/MSAAFNet/results/' # set the data directory,
...
gt_dir = 'ORSI-4199-gts' # set the ground truth folder name
rs_dirs = ['ORSI-4199'] # set the folder names of Predicted dataset
# rs_dirs = ['Ours', 'ACCoNet', 'AGNet', 'DAFNet', 'EMFINet', 'ERPNet', 'LVNet', 'MCCNet', 'MJRBM', 'RRNet', 'SARNet']
# '%Ours', 'SCRN', 'EGNet', '%ITSD', 'DFI', '%GCPANet', 'PurNet', 'GateNet', 'MINet'
...
#                     xrange = (0.8, 1), # the showing range of x-axis
#                     yrange = (0.8, 0.96), # the showing range of y-axis
...
#                     lineSylClr = lineSylClr, # curve styles, shape (num_rs_dir)
#                     linewidth = linewidth, # curve width, shape (num_rs_dir)
#                     xrange = (0, 1), # the showing range of x-axis
#                     yrange = (0.85, 0.95), # the showing range of y-axis
#                     dataset_name = data_name, # dataset name will be drawn on the bottom center position
#                     save_dir = data_dir, # figure save directory
#                     save_fmt = 'png') # format of the to-be-saved figure
# print('\n')
